...
class SafeSessionMiddleware(SessionMiddleware, MiddlewareMixin):
    ...
    def _verify_user(request, userid_in_session):
        ...
        if getattr(request, 'safe_sessions_expected_user_change', None):
            return
...
def mark_user_change_as_expected(request, new_user_id):
    """
    ...
    """
    request.safe_sessions_expected_user_change = {'new_user_id': new_user_id}
